...
class AppUtils {
  ...
  static String formatAyahNumber(int number) {
    final hindiDigits = ['٠', '١', '٢', '٣', '٤', '٥', '٦', '٧', '٨', '٩'];
    return number.toString().split('').map((d) => hindiDigits[int.parse(d)]).join();
  }
  ...
  static String getSurahName(int surahNumber) {
    ...
    return names[surahNumber] ?? 'Unknown';
  }

  static Color getRevelationColor(String type) {
    return type.toLowerCase() == 'meccan' ? Colors.amber.shade700 : Colors.green.shade700;
  }
}
